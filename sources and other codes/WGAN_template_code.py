# source: https://github.com/ray0809/simple-wgan-with-minist
...
def initNormal():
    return initializers.RandomNormal(stddev=0.2)
...
H = Dense(256, kernel_initializer=initializers.random_normal(stddev=0.2))(g_input)
H = LeakyReLU(0.2)(H)
...
D = Dense(1024, kernel_initializer=initializers.random_normal(stddev=0.2))(d_input)
D = LeakyReLU(0.2)(D)
D = Dropout(0.3)(D)
