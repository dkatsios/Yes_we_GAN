...
def build_and_train(model_params, train_params):
    ...
    model_params:
      ...
      The arguments of model_params are:
        ...
        - data_type: (string) with the data type (extension) of the training files (e.g. 'png')
                     ...
                     the number of the channels (e.g. if there is Alpha channel) will be recognized automatically
        ...
        - save_folders: (dictionary) with keys 'images_folder' and 'models_folder'
                        ...
                        if None, the default paths will be used (./result_images/dataset/ and ./result_models/dataset/)
    ...
    train_params:
      ...
      The arguments of train_params are:
        - epochs: (integer) number of epochs (each epoch runs for as many repetitions defined at gen_to_disc_ratio)
